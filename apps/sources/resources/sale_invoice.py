...
from apps.sources.outputs.sale_invoice import fields_item_sale_invoice, fields_item_sale_invoice_cn
from apps.sources.reqparsers.sale_invoice import (
    structure_key_item,
    structure_key_items,
...
from apps.sources.apis.sale_invoice import (
...
class SaleInvoiceResource(Resource):
    ...
    def get(self, pk):
        """
        Example:
            curl http://0.0.0.0:5000/sources/sale_invoice/1
        :param pk:
        :return:
        """
    ...
    def delete(self, pk):
        """
        Example:
            curl http://0.0.0.0:5000/sources/sale_invoice/1 -X DELETE
        :param pk:
        :return:
        """
...
class SaleInvoiceListResource(Resource):
    ...
    def get(self):
        """
        Example:
            curl http://0.0.0.0:5000/sources/sale_invoices
            curl http://0.0.0.0:5000/sources/sale_invoices?last_pk=1000&limit_num=2
        :return:
        """
        # 条件参数
...
class SaleInvoicePaginationResource(Resource):
    ...
    def get(self):
        """
        Example:
            curl http://0.0.0.0:5000/sources/sale_invoices/pagination
            curl http://0.0.0.0:5000/sources/sale_invoices/pagination?page=2000&per_page=2
        :return:
        """
        # 条件参数
        filter_parser = reqparse.RequestParser(bundle_errors=True)
