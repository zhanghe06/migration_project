...
from apps.models.db_target import SupplierInvoice
...
def get_supplier_invoice_limit_rows_by_last_id(last_pk, limit_num, *args, **kwargs):
    """
    ...
    :return:
    """
    return db_instance.get_limit_rows_by_last_id(SupplierInvoice, last_pk, limit_num, *args, **kwargs)
...
def delete_supplier_invoice(supplier_invoice_id, force=False):
    """
    删除信息
    :param supplier_invoice_id:
    :param force:
    ...
    if force:
        ...
        return db_instance.edit(SupplierInvoice, supplier_invoice_id, data)
...
def delete_supplier_invoice_table():
    """
    清空表
    :return:
    """
    return db_instance.delete_table(SupplierInvoice)


def count_supplier_invoice(*args, **kwargs):
    """
    计数
    :param args:
    :param kwargs:
    :return:
    """
    return db_instance.count(SupplierInvoice, *args, **kwargs)
