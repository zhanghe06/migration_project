...
def get_delivery_items_row_by_id(delivery_items_id):
    ...
    :return: None/object
    """
    return db_instance.get_row_by_id(DeliveryItems, delivery_items_id)


def get_delivery_items_row(*args, **kwargs):
    """
    获取信息
    :param args:
    :param kwargs:
    :return: None/object
    """
    return db_instance.get_row(DeliveryItems, *args, **kwargs)
...
def get_delivery_items_limit_rows_by_last_id(last_pk, limit_num, *args, **kwargs):
    """
    ...
    :return:
    """
    return db_instance.get_limit_rows_by_last_id(DeliveryItems, last_pk, limit_num, *args, **kwargs)
...
def delete_delivery_items(delivery_items_id, force=False):
    """
    删除信息
    :param delivery_items_id:
    :param force:
    ...
    if force:
        ...
        return db_instance.edit(DeliveryItems, delivery_items_id, data)
